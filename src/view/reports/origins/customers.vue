	...
	<div class="c-grid">
		<div class="box box-query">
			<Form ref="ref_search" :model="search_field" :label-width="80" class="filter-form row">
				...
				<Form-item label="手机号码" prop="first_tel" class="col-sm-3">
					<Input v-model="search_field.first_tel" placeholder="手机号码"></Input>
				</Form-item>
			...
			<Row class="basic">
	            <Col span="24" class="mt-2">
                	...
                	<export-button res="customers" :params="params"></export-button>
	            </Col>
	        </Row>         
		</div>
		<div class="box box-result">
	        ...
	        <div class="content">
				<div class="content-body">
			        <Table 
			        v-loading.like="'franchisee_customers'"
			        :page-size="pageSize"
			        :page="pageIndex"
			        :stripe="true"
			        :show-header="true"
