<template>
	<Modal :title="modal$.title" draggable v-model="modal$.show" :mask-closable="false" width="700">
			...
			<Tabs v-model="current_tab">
				...
				<div slot="extra">
					<x-upload 
						...
						<Button type="default" size="small" icon="md-desktop">本地上传</Button>
					</x-upload>
					<Button size="small" type="default" icon="ios-chatbubbles" @click="uploadByWechat">通过微信上传</Button>
				</div>
			</Tabs>
		</template>
		<div slot="footer">
