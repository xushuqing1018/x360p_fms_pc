    	...
    	<div @click="openModal">
	    	<slot>
		        <div
		            ...
		            <Icon type="ios-close-circle" :class="[prefixCls + '-arrow']" v-if="showCloseIcon" @click.native.stop="clearSelected"></Icon>
		            <Icon type="md-arrow-dropdown" :class="[prefixCls + '-arrow']"></Icon>
		        </div>
	        </slot>
        </div>    
    </div>
