<template>
    <Modal draggable v-model="modal$.show" :mask-closable="true" :width="width" :title="modal$.title" @on-cancel="closeModal">
    	<div :class="classes">
    		<div class="list-main">
                	...
                	<Row>
                		...
                		<Col span="16">
                            <div class="pull-right">
		                        <per-scope per="franchisee.all" @on-change="type_franch=$event"></per-scope>
		                   	</div>
                		</Col>
                	</Row>
                </div>
                <div class="list-body">
                    <div class="list-body-wrap" v-loading.like="'franchisees'">
                        <table class="table-list">
                            <thead>
                                <tr>
                                    ...
                                    <th><div class="ivu-table-cell">联系人</div></th>
                                    <th><div class="ivu-table-cell">运营状态</div></th>
                                    <th><div class="ivu-table-cell">签约</div></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr :class="{'table-info':item.$selected}" @click="toggleSelected(item)" v-for="item in data">
                                    ...
                                    <td><div class="ivu-table-cell">{{item.status|business_status}}</div></td>
                                    <td>
                                        <div class="ivu-table-cell">
                                            <span :class="{'text-success':item.is_sign}">{{item.is_sign|sign_status}}</span>
                                        </div>
                                    </td>
                                </tr>
