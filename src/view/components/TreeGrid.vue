...
<template>
    <div :style="{width:tableWidth}" class='autoTbale'>
        <table class="table" id='hl-tree-table'>
            <thead>
                <tr>
                    <th v-for="(column,index) in cloneColumns" style="text-align: left">
                    ...
                    <td v-for="(column,snum) in columns" :key="column.key" :style="tdStyle(column)">
                        ...
                        <div v-if="column.type === 'action'" class="btn_wrap">
                            <i-button 
                                ...
                                v-if="!(item.dpt_id == 0&&(action.type == 'edit'||action.type == 'delete'))"
                                :key="action.text">
                            </i-button>
                        ...
                        <label @click="toggle(index,item)" v-if="!column.type">
                            <span v-if='snum==iconRow()'>
                                ...
                                <i v-if="item.children&&item.children.length>0" class="ivu-icon" :class="{'ivu-icon-md-add-circle':!item.expanded,'ivu-icon-md-remove-circle':item.expanded }"></i>
                                ...
                                <Icon type="md-git-merge" size="14" v-else></Icon>
                            </span>
