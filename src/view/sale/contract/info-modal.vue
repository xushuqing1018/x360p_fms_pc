<template>
	<Modal draggable v-model="modal$.show" :title="modal$.title" :mask-closable="false" width="650">
		<Form ref="form" :model="info" :label-width="100">
			<Row>
				...
				<Col span="12">
					<Form-item label="签约员工" prop="sign_eid" class="ivu-form-item-required">
			...
			<Row>
				<Col span="12">
					<Form-item label="特许经营费" prop="join_fee1">
						<Input v-model="info.join_fee1" style="width: 120px;">
				...
				<Col span="12">
					<Form-item label="履约保证金" prop="join_fee2">
						<Input v-model="info.join_fee2" style="width: 120px;">
							<span slot="append">元</span>
						</Input>
					</Form-item>
				</Col>
			...
			<Row>
				<Col span="12">
					<Form-item label="年度使用费" prop="join_fee3">
						<Input v-model="info.join_fee3" style="width: 120px;">
							<span slot="append">元</span>
						</Input>
					</Form-item>
				</Col>
				<Col span="12">
					<Form-item label="教育商品款" prop="join_fee4">
						<Input v-model="info.join_fee4" style="width: 120px;">
							<span slot="append">元</span>
						</Input>
					</Form-item>
				</Col>
			...
			<Row>
				<Col span="12">
					<Form-item label="合同总金额" prop="contract_amount">
						<Input v-model="info.contract_amount" style="width: 120px;">
							<span slot="append">元</span>
						</Input>
					</Form-item>
				</Col>
			...
			<Form-item label="合同附件">
				<review-upload v-model="info.franchisee_contract_file"></review-upload>
			</Form-item>
		</Form>
		<div slot="footer">
