...
<template>
	<div class="c-grid">		
		<div class="box box-result">
			<div class="content">
				<div class="mb-3">
					<Button type="primary" icon="md-refresh" @click="init_data" :loading="loading">刷新</Button>
					<Button type="primary" icon="md-add" class="ml-3" @click="addInfo">新增</Button>
				</div>
									...
									<td>
										<div class="ivu-table-cell">
											<div class="ivu-table-cell-expand" v-if="filter_data(item.tt_id).length>0" @click="toggleExpand(item)">
												<Icon :type="item.expand?'ios-arrow-down':'ios-arrow-forward'"></Icon>
											</div>
										</div>
									</td>
									<td>
