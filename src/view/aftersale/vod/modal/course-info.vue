<template>
	<Modal draggable v-model="modal$.show" :title="modal$.title" :mask-closable="false" :width="500">
		<Form ref="form" :model="info" :label-width="90" :rules="rules">
			<FormItem label="会议主题" prop="topic" style="width: 80%">
				<Input v-model="info.topic" placeholder="请输入会议主题" />
			</FormItem>
			<FormItem label="开始日期" prop="start_int_day">
				<DatePicker v-model="info.start_int_day" type="date" placeholder="选择开始日期" style="width: 110px"></DatePicker>                 </FormItem>

			<FormItem label="结束日期" prop="end_int_day">
				<DatePicker v-model="info.end_int_day" type="date" placeholder="选择结束日期" style="width: 110px"></DatePicker>                   </FormItem>
		</Form>
		<div slot="footer">
