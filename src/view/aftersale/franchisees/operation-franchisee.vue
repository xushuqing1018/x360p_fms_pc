<template>
	<Dropdown trigger="click" :transfer="true" :placement="placement">
		<slot>
			<Button type="primary" size="small">操作 <Icon type="md-arrow-dropdown"></Icon></Button>
		</slot>
		<DropdownMenu slot="list">
			...
			<DropdownItem v-per="'francharchive.open'" @click.native="open" v-if="info.fc_og_id==0">
				<Icon type="android-open"></Icon>  开通校360系统
			</DropdownItem>
			<DropdownItem v-per="'francharchive.link'" @click.native="link" v-if="info.fc_og_id==0">
